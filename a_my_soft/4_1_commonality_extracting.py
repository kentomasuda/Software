# -*- coding: utf-8 -*-
"""
Created on Thu Jan  9 16:56:16 2025
...
for i in range(len(years)):
    for j in range(i + 1, len(years)):
        ...
        # year1 と year2 の最後の 2 文字が異なる場合のみ計算を実行
        if year1[-2:] != year2[-2:]:
            ...
            print(year1, year2, average_similarity)
            
            # 平均類似度が middle_threshold 未満の場合
...
# 結果をファイルに保存
output_filename = "high_similarity_pairs_with_descriptions1111.txt"

with open(output_filename, 'w', encoding='utf-8') as output_file:

    for year1, year2, text1, text2, sim in high_similarity_pairs:
        output_file.write(f"{year1}\n{year2}\n")
        output_file.write(f"{text1}\n{text2}\n\n")
